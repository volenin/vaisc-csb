...
def main(bucket_name):
    ...
    branch_number = os.environ.get("BRANCH_NUMBER_TUTORIAL", "1")
    default_catalog = f"projects/{project_id}/locations/global/catalogs/default_catalog/branches/{branch_number}"

    gcs_bucket = f"gs://{bucket_name}"
    gcs_errors_bucket = f"{gcs_bucket}/error"
    gcs_products_object = "products_tutorial.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument("bucket_name", nargs="?", default=os.environ["RETAIL_BUCKET_NAME"])
